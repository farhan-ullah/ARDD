          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10),
                Padding(
                    padding: EdgeInsets.symmetric(horizontal: 112, vertical: 3),
                    child: Text(
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
                ...
                child: TextFormField(
                  validator: (input) =>
                      input.contains('@') ? 'invalid input' : null,
                  autofocus: false,
                  obscureText: true,
                  decoration: InputDecoration(
                    enabledBorder: OutlineInputBorder(
            ...
            Padding(
                ...
                child: TextFormField(
                  validator: (input) => input.length < 11
                      ? 'phome number should be atleast 11 digits'
                      : null,
                  autofocus: false,
                  obscureText: true,
                  decoration: InputDecoration(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
                ...
                //   child: show ? Text("Sign In") : Container(),
                // ),
                // AnimatedSize(
                //   vsync: this,
